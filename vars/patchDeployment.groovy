...
def it21UiInstaller(target,host,buildVersion) {
	def installer = {
		node {
			...
			ssh(host,"sudo mkdir ${uiGettingExtractedFolder}/log")
			ssh(host,"sudo chown -R apg_install ${uiGettingExtractedFolder}/log")
			ssh(host,"sudo chmod 777 ${uiGettingExtractedFolder}/log")
			ssh(host,"sudo mkdir ${uiGettingExtractedFolder}/jxbrowser")
			ssh(host,"sudo chown -R apg_install ${uiGettingExtractedFolder}/jxbrowser")
			ssh(host,"sudo chmod 777 ${uiGettingExtractedFolder}/jxbrowser")
